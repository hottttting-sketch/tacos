        ...
        projects.forEach(p => {
          ...
          stations.forEach(s => {
            ...
            excelRows.push({
              ...
              projectId: p.id,
              station: s,
              agency: p.metadata?.agency_name || '電通', // 代理店名
             ...
             <div style={{ backgroundColor: 'white', border: '1.5px solid #F1E4C9', borderRadius: '24px', overflow: 'hidden', boxShadow: '0 4px 6px rgba(0,0,0,0.02)' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                   <thead style={{ backgroundColor: '#fcfcfd', borderBottom: '1.5px solid #F1E4C9' }}>
                      <tr>
                        {['スポンサー', '案件名', thirdColHeader, '放送予定日', 'ステータス', 'チャット'].map(h => (
...
if (excelTabPattern.test(content)) {
    ...
    console.log('Successfully updated Excel View columns for Broadcaster UI!');
} else {
